...
typedef struct
{
	...
	union
	{
		...
		struct
		{
			...
			__RO	uint32_t	ICFBSCR_RES_16	:1;
			__RO	uint32_t	ICFBSCR_RES_17	:1;
			__RO	uint32_t	ICFBSCR_RES_18	:1;
			__RO	uint32_t	ICFBSCR_RES_19	:1;
			__RO	uint32_t	ICFBSCR_RES_20	:1;
			__RO	uint32_t	ICFBSCR_RES_21	:1;
			__RO	uint32_t	ICFBSCR_RES_22	:1;
			__RO	uint32_t	ICFBSCR_RES_23	:1;
			__RO	uint32_t	ICFBSCR_RES_24	:1;
			__RO	uint32_t	ICFBSCR_RES_25	:1;
			__RO	uint32_t	ICFBSCR_RES_26	:1;
			__RO	uint32_t	ICFBSCR_RES_27	:1;
			__RO	uint32_t	ICFBSCR_RES_28	:1;
