...
uint32_t mstp_check(void)
{
	uint32_t i, j, k;
	
    /* Registers read/write while module stop off */
    ...
    /* Activate module stop signal */
    CPG_SetBit(I2C0_MSTPCR, I2C0_MSTP_BIT_POS); 
    /* Wait until module stop signal is asserted */
    while(!(*I2C0_MSTPSR & (1 << I2C0_MSTP_BIT_POS)));

    /* Registers read/write while module stop on */
    ...
    /* Deactivate module stop signal */
    CPG_ClearBit(I2C0_MSTPCR, I2C0_MSTP_BIT_POS); 
    /* Wait until module stop signal is deasserted */
    while(*I2C0_MSTPSR & (1 << I2C0_MSTP_BIT_POS));

	/* Check if registers value is retained */
	...
	result[2][0][1] = I2C0->ICSCR;
    result[2][1][1] = I2C0->ICMCR;
    result[2][2][1] = I2C0->ICSSR;
    result[2][3][1] = I2C0->ICMSR;
    result[2][4][1] = I2C0->ICSIER;
    result[2][5][1] = I2C0->ICMIER;
    result[2][6][1] = I2C0->ICCCR;
    result[2][7][1] = I2C0->ICSAR;
    result[2][8][1] = I2C0->ICMAR;
    result[2][9][1] = I2C0->ICTXD;
    result[2][10][1] = I2C0->ICCCR2;
    result[2][11][1] = I2C0->ICMPR;
    result[2][12][1] = I2C0->ICHPR;
    result[2][13][1] = I2C0->ICLPR;
    result[2][14][1] = I2C0->ICFBSCR;
    result[2][15][1] = I2C0->ICDMAER;
